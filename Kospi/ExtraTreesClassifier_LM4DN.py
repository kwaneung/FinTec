...
if __name__ == '__main__':
    ...
    HM4UP = pd.read_csv('LM4DN.csv', encoding='CP949')
    ...
    feature = ["미국 ISM 제조업 구매자지수", "미국 소비자 신뢰지수", "미국의 소매판매지수", "필라델피아 연준 제조업지수"]
    ...
    ml = ExtraTreesClassifier(criterion='entropy', n_estimators=100, n_jobs=-1, random_state=0)
