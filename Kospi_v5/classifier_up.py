...
if __name__ == '__main__':
    for i in range(1):
        ...
        features = ['DATE', 'Open', 'High', 'Low', 'Close', 'Adj Close', '상품수지', 'LREMTTTTUSM156S', 'UNRATENSA']  # XGB
        ...
        ml = XGBClassifier(n_estimators=100, min_child_weight=1, max_depth=7, gamma=1)
