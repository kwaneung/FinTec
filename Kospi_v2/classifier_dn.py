...
if __name__ == '__main__':
    for i in range(1):
        ...
        # feature = ['NEWORDER', 'FEDFUNDS', '자가주거비포함지수']  # EXTRA
        # feature = ['ISM_PMI_Actual', 'USSLIND', 'XTIMVA01KRM667S']  # RANDOM
        # feature = ['자가주거비', 'EXJPUS', 'XTIMVA01KRM667S']  # XGB
        feature = ['EXJPUS', 'XTIMVA01KRM667S', 'KORCPIALLMINMEI']  # XGB2
        # print(feature)
        ...
        # ml = XGBClassifier(n_estimators=100, min_child_weight=1, n_jobs=-1, max_depth=6, gamma=0)
        ml = XGBClassifier(n_estimators=100, min_child_weight=1, n_jobs=-1, max_depth=6, gamma=0, random_state=0)
